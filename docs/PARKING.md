...
| 2026-07-21 | Compléter `TIER_DISPLAY_FR` (`lib/tier-display.ts`) avec les 7 mots de marque FR des tiers validés par Samo (fallback EN en attendant) → micro-OTA | B27-app (arbitrage C) | En attente mots Samo |
